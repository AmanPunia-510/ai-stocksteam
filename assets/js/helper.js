...
function generateReviewCard(review) {
  return `
    ...
    <div class="d-flex flex-column  justify-start  gap_24">
      <div class="d-flex flex-column justify-start gap_24">
  <div class="d-flex w-100 justify-content-between align-items-start align-items-md-center">
    ...
    <div class="d-flex flex-column ms-2 ps-1">
      ...
      <img class="slider_stars" src="${review.stars}" alt="Stars"/>
        ...
        <div><p class="text_light_green ff_roboto mb-0 fw-black opacity_07 text-nowrap">Invested <span class=
              "text_rich_black ">350 CAD</span></p>
              <p class="text_light_green mb-0 ff_roboto fw-black opacity_07 text-nowrap"> Profit:<span class="text_rich_black "> 3,784 CAD </span></p></div>
  </div>
